...
#SBATCH --job-name="3skernel"
#SBATCH -o kerr3sv2_%a.out
#SBATCH -e kerr3sv2_%a.err
#SBATCH --array=0   # 0-499,  can also take the format array=1-10,22,34,39-45 for example. 100 jobs: array=0-99
